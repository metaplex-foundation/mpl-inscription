...
import { MPL_INSCRIPTION_PROGRAM_ID, findInscriptionMetadataPda, findMintInscriptionPda, initialize, initializeFromMint, writeData } from '../src';
...
test('it can set JSON data on a mint inscription account', async (t) => {
  ...
  // When we create a new account.
  builder = builder.add(initializeFromMint(umi, {
