...
impl InitializeBuilder {
  pub fn new() -> Self {
    Self::default()
            ...
            /// The account to store the metadata in.
#[inline(always)]
    pub fn inscription_account(&mut self, inscription_account: solana_program::pubkey::Pubkey) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = Initialize {
                              inscription_account: self.inscription_account.expect("inscription_account is not set"),
...
impl<'a, 'b> InitializeCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      /// The account to store the metadata in.
#[inline(always)]
    pub fn inscription_account(&mut self, inscription_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          inscription_account: self.instruction.inscription_account.expect("inscription_account is not set"),
