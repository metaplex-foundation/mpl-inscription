...
impl InitializeFromMint {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = InitializeFromMintInstructionData::new().try_to_vec().unwrap();
...
impl InitializeFromMintBuilder {
  pub fn new() -> Self {
    Self::default()
            ...
            /// The account to store the metadata in.
#[inline(always)]
    pub fn mint_inscription_account(&mut self, mint_inscription_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.mint_inscription_account = Some(mint_inscription_account);
                    self
    }
            /// The account to store the inscription account's metadata in.
#[inline(always)]
    pub fn inscription_metadata_account(&mut self, inscription_metadata_account: solana_program::pubkey::Pubkey) -> &mut Self {
...
#[inline(always)]
    pub fn mint_account(&mut self, mint_account: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            /// The metadata for the mint.
#[inline(always)]
    pub fn token_metadata_account(&mut self, token_metadata_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.token_metadata_account = Some(token_metadata_account);
                    self
    }
            /// The shard account for the inscription counter.
#[inline(always)]
    pub fn inscription_shard_account(&mut self, inscription_shard_account: solana_program::pubkey::Pubkey) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = InitializeFromMint {
                              mint_inscription_account: self.mint_inscription_account.expect("mint_inscription_account is not set"),
                                        inscription_metadata_account: self.inscription_metadata_account.expect("inscription_metadata_account is not set"),
                                        mint_account: self.mint_account.expect("mint_account is not set"),
                                        token_metadata_account: self.token_metadata_account.expect("token_metadata_account is not set"),
                                        inscription_shard_account: self.inscription_shard_account.expect("inscription_shard_account is not set"),
...
impl<'a, 'b> InitializeFromMintCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      /// The account to store the metadata in.
#[inline(always)]
    pub fn mint_inscription_account(&mut self, mint_inscription_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.mint_inscription_account = Some(mint_inscription_account);
                    self
    }
      /// The account to store the inscription account's metadata in.
#[inline(always)]
    pub fn inscription_metadata_account(&mut self, inscription_metadata_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.inscription_metadata_account = Some(inscription_metadata_account);
                    self
    }
      /// The mint that will be used to derive the PDA.
#[inline(always)]
    pub fn mint_account(&mut self, mint_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.mint_account = Some(mint_account);
                    self
    }
      /// The metadata for the mint.
#[inline(always)]
    pub fn token_metadata_account(&mut self, token_metadata_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.token_metadata_account = Some(token_metadata_account);
                    self
    }
      /// The shard account for the inscription counter.
#[inline(always)]
    pub fn inscription_shard_account(&mut self, inscription_shard_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          mint_inscription_account: self.instruction.mint_inscription_account.expect("mint_inscription_account is not set"),
                  
          inscription_metadata_account: self.instruction.inscription_metadata_account.expect("inscription_metadata_account is not set"),
                  
          mint_account: self.instruction.mint_account.expect("mint_account is not set"),
                  
          token_metadata_account: self.instruction.token_metadata_account.expect("token_metadata_account is not set"),
                  
          inscription_shard_account: self.instruction.inscription_shard_account.expect("inscription_shard_account is not set"),
